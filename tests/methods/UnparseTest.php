...
class UnparseTest extends Testcase
{
    ...
    public function testUnparseWithParameters(): void
    {
        $fields = ['a' => 'AA', 'b' => 'BB'];
    ...
    public function testUnparseDefault(): void
    {
        $expected = "column1,column2\rvalue1,value2\rvalue3,value4\r";
        $this->unparseAndCompare($expected);
    }

    public function testUnparseDefaultWithoutHeading(): void
    {
    ...
    public function testUnparseRenameFields(): void
    {
    ...
    public function testSubsetFields(): void
    {
        $expected = "column1\rvalue1\rvalue3\r";
        $this->unparseAndCompare($expected, ['column1']);
    }

    public function testReorderAndRenameFields(): void
    {
        $fields = [
            'column2' => 'C2',
            'column1' => 'C1',
    ...
    public function testUnparseDefaultFirstRowMissing(): void
    {
    ...
    public function testUnparseDefaultWithoutData(): void
    {
        unset($this->csv->data[0], $this->csv->data[1]);
        $expected = "column1,column2\r";
        $this->unparseAndCompare($expected);
    }

    public function testObjectCells(): void
    {
        $this->csv->data = [
            [
    ...
    private function unparseAndCompare(string $expected, array $fields = []): void
    {
